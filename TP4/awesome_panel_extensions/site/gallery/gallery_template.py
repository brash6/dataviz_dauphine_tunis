...
import param
from panel.template.base import FAVICON_URL, Template

from TP4.awesome_panel_extensions.site.models import Application
...
class GalleryTemplate(Template):
    ...
    background_image = param.String(
        "http://lestroisjardins.fr/wp-content/uploads/2016/04/White-header-background-1.jpg",  # pylint: disable=line-too-long
        doc="""
    ...
    target = param.ObjectSelector(
        "_self",
        objects=["_blank", "_parent", "_top", "_self"],
        doc="""
