...
from TP4.awesome_panel_extensions.assets.svg_icons import ICONS
...
class User(_BaseModel):
    ...
    >>> from TP4.awesome_panel_extensions.site.models import User
    >>> User(
...
class Application(_BaseModel):
    ...
    >>> from TP4.awesome_panel_extensions.site.models import User, Application
    >>> philipp = User(
    ...     name = "Philipp Rudiger",
    ...     url = "https://github.com/philippjfr",
    ...     email = "na@hotmail.com",
