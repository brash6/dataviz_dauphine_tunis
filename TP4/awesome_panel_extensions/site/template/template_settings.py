"""The TemplateSettings contains a collecation of user definable settings"""
import panel as pn
import param

from TP4.awesome_panel_extensions._shared.logger import get_logger
from TP4.awesome_panel_extensions.models.icon import Icon
from TP4.awesome_panel_extensions.widgets.button import AwesomeButton
...
class TemplateSettings(param.Parameterized):
    ...
    template = param.ObjectSelector(
        DEFAULT_TEMPLATE,
        objects=["bootstrap", "fast", "fastgrid", "golden", "material", "react", "liveramp"],
    )
