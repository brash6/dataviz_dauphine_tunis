...
from TP4.awesome_panel_extensions.site.template.template_settings import (
    DEFAULT_TEMPLATE,
    DEFAULT_THEME,
    TemplateSettings,
)
...
TEMPLATES: Dict[str, pn.template.BaseTemplate] = {
    "liveramp": pn.template.VanillaTemplate,
...
THEMES = {
    "liveramp": {"default": pn.template.DefaultTheme, "dark": pn.template.DarkTheme},
