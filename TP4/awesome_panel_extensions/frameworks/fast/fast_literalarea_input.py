...
from TP4.awesome_panel_extensions.bokeh_extensions.fast.fast_textarea_input import (
    FastTextAreaInput as _BkFastTextAreaInput,
)
from TP4.awesome_panel_extensions.frameworks.fast.fast_textarea_input import (
    _FastTextAreaInputMixin,
)
