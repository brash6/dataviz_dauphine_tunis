...
from TP4.awesome_panel_extensions.frameworks.fast import styles
from TP4.awesome_panel_extensions.frameworks.fast.templates.base import GridBasicTemplate
