...
from TP4.awesome_panel_extensions.frameworks._base.config import BUTTON_TYPES
from TP4.awesome_panel_extensions.frameworks.material.config import MWC_ICONS
from TP4.awesome_panel_extensions.web_component import WebComponent
