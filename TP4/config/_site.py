...
from TP4.awesome_panel_extensions import site as _site
from TP4.awesome_panel_extensions.assets import svg_icons
...
class ApplicationLiveramp(Application):
    folder = param.String()
...
class AwesomePanelSite(_site.Site):
    ...
    def create_application(  # pylint: disable=too-many-arguments
        ...
        return ApplicationLiveramp(**params)
