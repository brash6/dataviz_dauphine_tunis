...
from TP4.awesome_panel.application.templates.application_template import ApplicationTemplate
from TP4.awesome_panel.utils import holoviews_ext
from TP4.awesome_panel_extensions.frameworks import material
